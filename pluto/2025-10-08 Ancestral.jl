...
import PlutoUI, Makie, CairoMakie, Logomaker, PythonPlot, ColorSchemes, BioStructures, TransitionPaths2025, FASTX, BioSequences, DataFrames, CSV

# ╔═╡ e3048c41-237e-4817-b119-f08b4d65f4c8
ancestor_1to2_batch4_sequences = BioSequences.LongAA.(
	FASTX.sequence.(FASTX.FASTAReader(open("/Users/jfdcd/projects/2024/Transition_Paths/TransitionPaths2025.jl/data/ancestral/ancestor_1to2_batch4.fa"))));

# ╔═╡ c264b192-3e71-4155-aaad-00efef9b7222
ancestor_1to2_sequences = BioSequences.LongAA.(
	FASTX.sequence.(FASTX.FASTAReader(open("/Users/jfdcd/projects/2024/Transition_Paths/TransitionPaths2025.jl/data/ancestral/ancestor_1to2.fa"))));

# ╔═╡ 840c0178-6247-4655-8ed3-b03d4db9cdf2
ancestor_1to4_sequences = BioSequences.LongAA.(
	FASTX.sequence.(FASTX.FASTAReader(open("/Users/jfdcd/projects/2024/Transition_Paths/TransitionPaths2025.jl/data/ancestral/ancestor_1to4.fa"))));

# ╔═╡ a821dc9e-b172-4f37-9c69-2ec7cc202778
ancestor_1to2_batch4 = TransitionPaths2025.onehot(ancestor_1to2_batch4_sequences);

# ╔═╡ 0e99ba98-bdae-49b5-b9aa-77f2a4efc195
ancestor_1to2 = TransitionPaths2025.onehot(ancestor_1to2_sequences);

# ╔═╡ 449c216f-cc8d-47d3-9868-522989c1cf14
ancestor_1to4 = TransitionPaths2025.onehot(ancestor_1to4_sequences);
...
df_ancestor_1to2_batch4 = DataFrames.DataFrame(;
	...
	Eglob = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:global, ancestor_1to2_batch4),
	EI = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:I, ancestor_1to2_batch4),
	EIII = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:II, ancestor_1to2_batch4),
	EIV = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:IV, ancestor_1to2_batch4),
);

# ╔═╡ f525ebd2-0ee1-4d32-a380-deec48160d92
df_ancestor_1to2 = DataFrames.DataFrame(;
	seq = string.(ancestor_1to2_sequences),
	Eglob = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:global, ancestor_1to2),
	EI = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:I, ancestor_1to2),
	EIII = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:II, ancestor_1to2),
	EIV = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:IV, ancestor_1to2),
);

# ╔═╡ 9c6072c1-e06c-4e79-8333-cd2379f29ecd
df_ancestor_1to4 = DataFrames.DataFrame(;
	seq = string.(ancestor_1to4_sequences),
	Eglob = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:global, ancestor_1to4),
	EI = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:I, ancestor_1to4),
	EIII = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:II, ancestor_1to4),
	EIV = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(:IV, ancestor_1to4),
);
...
let file_path = joinpath(dir_path_for_rbm_scores, "1to4_batch3_full.csv")
	...
	for rbm = (:I, :II, :IV, :global)
		scores = TransitionPaths2025.Eugenio_RBM_20230419_loglikelihood(rbm,  TransitionPaths2025.onehot(sampled_path))
